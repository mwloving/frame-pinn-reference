...
diffusion term is the most eliminable.
    ...
    python allen_cahn_demo.py
"""

import torch

from trainer import train
from eliminability import retrain_eliminability
from ordering import ordering_defect
import allen_cahn
...
def main(seed: int = 0, steps: int = 700):
    ...
    er = retrain_eliminability(
        allen_cahn.build_model,
        bf,
        train,
        steps=steps,
        lr=2e-3,
